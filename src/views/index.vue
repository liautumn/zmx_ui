  ...
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <div v-if="isAdmin">
        ...
        <el-badge :value="map.adminYPJ" :max="99" class="item">
          <el-button size="small" @click="() => {
          this.queryParams.stateIn = '5';
          this.flag1 = '1';
          this.getList();
        }">已评价
          </el-button>
      ...
      <div v-if="!isAdmin">
        ...
        <el-badge :value="map.DPJ" :max="99" class="item">
          <el-button size="small" @click="() => {
          this.queryParams.stateIn = '5';
          this.flag2 = '1';
          this.getList();
      ...
      <el-form-item label="家长手机号码" prop="userPhone" label-width="80" v-if="isAdmin">
        <el-input
    ...
    <el-dialog :title="title" :visible.sync="open" width="800px" append-to-body>
      ...
      <div class="dialog-footer">
        <el-button class="btnPublic" type="primary" v-if="!isAdmin && (form.state == null)" @click="submitForm('1')">保
          存
        </el-button>
        <button class="button btnPublic" @click="animateButtonClick"
                v-if="!isAdmin && (form.state == '1' || form.state == null)">
          <span class="default">提交</span>
    ...
    getList() {
      let params = {
        ...
        ...{
          "flag1": this.flag1,
          "flag2": this.flag2,
          "stateIn": this.queryParams.stateIn.split(",")
        }
      }
      // this.loading = true;
      listUserFillInfo(params).then(response => {
